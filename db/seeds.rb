...
kung = Owner.create!(first_name: 'Khun', last_name: 'Kung', uid: 'goong@gmail.com', password: '123456', location: "Chaloem Phrakiat Ratchakan Thi 9 Soi 59 Khwaeng Dok Mai, Khet Prawet Krung Thep Maha Nakhon 10250 Thailand", description: "Lifetime hair enthusiast, born and raised in Bangkok", provider: "codetribute")
...
kristie = Developer.create!(first_name: "Kristie", last_name: 'Chow', uid: 'kristie@gmail.com', password: '123456', provider: "codetribute", location: "New York", description: "Newly graduated programmer located in Manhattan. I like travel, coding, and discovering new things around the world.", skill_ids: dev_skill_ids, slack_id: 'kristie1021')
...
dan = Developer.create!(first_name: 'Dan', last_name: 'Andersen', uid: 'danandersen2@gmail.com', password: '123456', location: "New York", description: "DBC Grad. Fun lover.", provider: "codetribute", skill_ids: dev_skill_ids, slack_id: 'dandersen2')

mira = Developer.create!(first_name: 'Mira', last_name: 'Scarvalone', uid: 'mirascarvalone@gmail.com', password: '123456', location: "New York", description: "Dev Bootcamp Graduate. Awesome web developer.", provider: "codetribute", skill_ids: dev_skill_ids, slack_id: 'mirascarvalone')
...
kb = Developer.create!(first_name: 'K.B.', last_name: 'DiAngelo', uid: 'kb-diangleo@gmail.com', password: '123456', location: "New York", description: "Dev Bootcamp Graduate. Awesome web developer.", provider: "codetribute", skill_ids: dev_skill_ids, slack_id: 'kaybidee')
...
devs.each do |dev|
  3.times do
    dev.received_reviews << Review.create!(comment: "Great, polished website. Clean design, quick response. I love it!", communication_rating: nums.sample, quality_rating: nums.sample, timeliness_rating: nums.sample, review_type: 'Owner', reviewee_id: dev.id, reviewer_id: owners.sample.id)
  end
end
...
project1 = Match.create!(user: mary, matched_user: kristie, status: "deployed on Heroku :)", accepted: "true")
