...
• Animsition and Sticky jQuery plugins with CSS3 for a custom, responsive web design
• Ransack for search bar functionality 
• Paperclip for uploading images
• Gmaps4rails for showing a business location
• Private Pub for instant messaging
